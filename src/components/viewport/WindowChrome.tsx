...
export function WindowChrome({ frame, cornerRadiusPx = 24, children }: WindowChromeProps) {
  ...
  return (
    <div
      ...
      className={`w-full h-full flex flex-col overflow-hidden bg-[#121216] transition-all duration-200 ${
        isFrameless
    ...
    >
      ...
      <div className="relative flex-1 w-full overflow-hidden bg-black flex items-center justify-center min-h-0">
        {children}
      </div>
    </div>
  );
